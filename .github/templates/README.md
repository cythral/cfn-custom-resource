...
```shell
dotnet add package Cythral.CloudFormation.CustomResource --version $PACKAGE_VERSION
```
...
```xml
<ItemGroup>
    <PackageReference Include="Cythral.CloudFormation.CustomResource" Version="$PACKAGE_VERSION" />
</ItemGroup>
```
